...
Pre-position the following in or near your safe room:

- Water (at least 10 litres)
- Phone chargers and power bank
- First aid kit
- Torch with batteries
- A bucket (sanitation if you can't use the bathroom)
- Your grab bags (if you haven't already evacuated, these should be staged here)

You probably won't use the safe room. But if you need it and haven't picked one, you'll be making decisions under extreme stress with your kids crying. Pick it now.

## Resource management

Sheltering in place burns through resources faster than you think. Here's how to manage what you have.

### Water

This is your most critical resource. You can survive days without food. Without water in a Karachi summer, you're in trouble within 24 hours.
...
Your UPS is not going to save you. A standard home UPS with 2 batteries gives you 4-6 hours of fans and lights. After that, you're on your own.
...
Nobody talks about this, but it matters by day two.
...
After dark, if your area has lost power but you haven't:

- Minimise visible light from your windows. Blackout curtains, garbage bags, blankets.
...
For a visual walkthrough, see the <FieldCardRef slug="fc-shutoff-utilities" title="Shutting Off Utilities Field Card" />.
...
This is the hardest call. You've been sheltering for two days. Things aren't getting better. When do you leave?
...
If you do decide to go, you're now executing the 30-Minute Window plan. Grab bags, rally points, communication tree. That guide covers the rest.

## Tonight

You don't need to buy anything tonight. Just do this:

1. **Pick your safe room.** Walk your family through it. "If things get bad, we all go here."
...
<PrintNote>Print this guide and keep it accessible at home. When the curfew is announced, you won't have time to search for it.</PrintNote>
