...
**B: Breathing.** Watch their chest. Is it rising and falling? If they're breathing, move on. If they're not breathing and you know CPR, start it. See the <FieldCardRef slug="fc-cpr-adult" title="CPR Field Card" /> for the technique. If you don't know CPR, focus on getting help.
...
1. Place it **2-3 inches above the wound**, not on a joint (elbow, knee). If the wound is on the lower arm, the tourniquet goes on the upper arm. If you're not sure where the wound is, go high: upper arm or upper thigh.
...
5. **Write the time on the tourniquet or on the patient's forehead.** Use a marker, a pen, anything. Write "TQ" and the time, e.g. "TQ 14:30." This tells medical staff how long the tourniquet has been on.
...
Whatever you use:
1. Wrap it around the limb, 2-3 inches above the wound
2. Tie a half-knot (like the first step of tying your shoes)
3. Place a stick, pen, wrench, or any rigid object on top of the half-knot
4. Tie a full knot over the rigid object
5. Twist the rigid object until the bleeding stops
6. Secure the rigid object by tying it to the limb with another strip of cloth
...
For the complete step-by-step, see the <FieldCardRef slug="fc-tourniquet" title="Tourniquet Field Card" />.
...
3. **Push the material into the wound.** Not on top of it, but into it. You're filling the cavity. Pack it tightly. Use your fingers to push the material down into the deepest part of the wound first, then pack on top.
...
<Callout type="warning" title="When NOT to pack">
...
For the visual step-by-step, see the <FieldCardRef slug="fc-wound-packing" title="Wound Packing Field Card" />.
...
1. **Find plastic.** A clean plastic bag, cling wrap, the wrapper from a bandage or cigarette pack. It needs to be large enough to cover the wound with at least 5 cm extra on all sides.
...
3. **Tape three sides.** Tape the top and two sides of the plastic to the skin. Leave the bottom side **untaped.** This creates a one-way valve: when the person inhales, the plastic seals against the wound. When they exhale, trapped air can escape through the untaped bottom edge.
...
For the full walkthrough, see the <FieldCardRef slug="fc-chest-seal" title="Chest Seal Field Card" />.
...
4. **Keep them warm.** Shock causes the body to lose heat rapidly. Cover them with whatever you have: a blanket, a chador, a jacket. Underneath them too, since cold ground pulls heat away fast.
...
6. **Keep talking to them.** Maintain eye contact. Tell them help is coming. Ask their name. Keep them conscious and as calm as possible. A person in shock who becomes unresponsive is deteriorating rapidly and needs immediate medical attention.

For a printable quick reference, see the <FieldCardRef slug="fc-shock" title="Shock Management Field Card" />.
...
**To splint:**
1. Pad the rigid object with cloth (a towel, dupatta, or clothing) so it doesn't press directly on skin
2. Place it along the limb, extending past the joints above and below the break
3. Tie it in place with strips of cloth, dupattas, or belts: above and below the fracture, not on it
4. Check circulation below the splint: can they feel their fingers or toes? Are they warm? If not, loosen slightly

**For arm injuries:** A dupatta or chunni makes an excellent sling. Fold it into a triangle, support the arm, tie behind the neck. See the <FieldCardRef slug="fc-sling" title="Arm Sling Field Card" />.

For the complete splinting guide, see the <FieldCardRef slug="fc-splint" title="Improvised Splint Field Card" />.
...
Burns are extremely common in blast and fire scenarios. The full treatment protocol is covered in the <FieldCardRef slug="fc-burns" title="Burns Field Card" />, but the essentials: cool running water on the burn for 10-20 minutes. Not ice, not butter, not toothpaste, not ghee. Just clean, cool water. Cover loosely with cling wrap or a clean, non-fluffy cloth. If the burn is larger than the person's palm, blistered, or on the face, hands, feet, or joints, they need a hospital.
...
<SupplyList title="Basic Trauma First Aid Kit">
<Item name="Gauze pads" detail="4x4 inch, pack of 10" price="Rs. 200-400" priority="critical" />
<Item name="Gauze roll" detail="2-3 rolls" price="Rs. 100-200" priority="critical" />
<Item name="Crepe bandage" detail="2-3 rolls, different widths" price="Rs. 150-300" />
<Item name="Medical tape" detail="1 roll, wide (2.5cm+)" price="Rs. 100-200" priority="critical" />
<Item name="Pyodine (povidone-iodine)" detail="50ml bottle" price="Rs. 100-150" priority="critical" />
<Item name="Disposable gloves" detail="Box of 10 pairs" price="Rs. 200-300" priority="critical" />
...
3. **Know your nearest trauma hospital.** Not the nearest clinic, but the nearest hospital with an emergency department. Know the route from home. Know the route from work.
...
<PrintNote>Print this guide. Keep it with your first aid kit. In an emergency, you won't remember the details; having the steps written down could make the difference.</PrintNote>
